import type { Task, Attachment, Comment, RecurrenceRule } from '../types';
...
export function normalizeTask(backendTask: Task): NormalizedTask {
    ...
    return {
        ...
        recurrenceRule: backendTask.recurrenceRule ? parseJsonString<RecurrenceRule | null>(backendTask.recurrenceRule, null) : null,
